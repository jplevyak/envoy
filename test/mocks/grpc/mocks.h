...
public:
  ...
  MOCK_METHOD0_T(closeStream, void()); MOCK_METHOD0_T(resetStream, void());
};
...
public:
  ...
  MOCK_METHOD6_T(sendRaw, AsyncRequest*(absl::string_view service_full_name, absl::string_view method_name,
  ...
  MOCK_METHOD3_T(startRaw, AsyncStream*(absl::string_view service_full_name, absl::string_view method_name,
